...
class PolyInter(object):
    def __init__(self, data: DataFrame, params: dict={'degree':4, 'pd':20, 'plot':False, 'progress_bar':False}):
        self.degree = params['degree']
        self.pd = params['pd']
        self.progress = params['progress_bar']
        
        # required matplotlib
        self.plot = params['plot']

        self.values = self.calc_poly(np.array(data))
