...
def premodel(currency: str, date: str, d_matrix: str, variables: dict, variables_set: str, timestemp: str, time_ahead: str) -> None:
...
def save(x: np.array, y: np.array, df: pd.DataFrame, target: pd.DataFrame, currency: str, d_matrix: str, type_situation: str, time_ahead: str, variables_set: str) -> None:
    save_path = f'./data/premodel/{currency}/{variables_set}/time_ahead_{time_ahead}/'
